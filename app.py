...
def get_font_b64():
    """Load Bengali font as base64 - tries NotoSansBengali first, falls back to FreeSans"""
    import base64, os
    # Try downloaded NotoSansBengali first (Render build)
    paths = [
...
<style>
  ...
  *{{ box-sizing:border-box; margin:0; padding:0; }}
    "+( "@font-face { font-family:'BnFont'; src:url('data:font/truetype;base64,"+FONT_B64+"') format('truetype'); }" if FONT_B64 else "")+"
  body{ font-family:'BnFont','Noto Sans Bengali',sans-serif; color:{C['navy']}; font-size:13px;
